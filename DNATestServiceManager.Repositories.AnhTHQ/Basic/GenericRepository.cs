...
namespace DNATestServiceManager.Repositories.AnhTHQ.Basic
{
    public class GenericRepository<T> where T : class
    {
        protected  SU25_PRN222_SE1706_G6_DNATestServiceManagerContext _context;

        public GenericRepository()
        {
            _context ??= new SU25_PRN222_SE1706_G6_DNATestServiceManagerContext();
        }

        public GenericRepository(SU25_PRN222_SE1706_G6_DNATestServiceManagerContext context)
        {
            _context = context;
        }
