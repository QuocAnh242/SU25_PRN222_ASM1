...
namespace DNATestServiceManager.Repositories.AnhTHQ.DBContext;

public partial class SU25_PRN222_SE1706_G6_DNATestServiceManagerContext : DbContext
{
    public SU25_PRN222_SE1706_G6_DNATestServiceManagerContext()
    {
    }

    public SU25_PRN222_SE1706_G6_DNATestServiceManagerContext(DbContextOptions<SU25_PRN222_SE1706_G6_DNATestServiceManagerContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<BookingMinhNDA> BookingMinhNda { get; set; }

    public virtual DbSet<FeedbackNguyenTq> FeedbackNguyenTqs { get; set; }

    public virtual DbSet<InvoiceMinhNDA> InvoiceMinhNda { get; set; }
    ...
    public virtual DbSet<ServiceAnhThq> ServicesAnhThqs { get; set; }
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-20F2N1R\\MSSQLSERVER01;Initial Catalog=SU25_PRN222_SE1706_G6_DNATestServiceManager;Persist Security Info=True;User ID=sa;Password=12345;Encrypt=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AppointmentLogTuTtcid).HasName("PK__Appointm__2DAE3DD459ACCB7A");
            ...
            entity.HasOne(d => d.AppointmentScheduleTuTtc).WithMany(p => p.AppointmentLogTuTtcs)
                ...
                .HasConstraintName("FK__Appointme__Appoi__5535A963");
        });

        modelBuilder.Entity<AppointmentScheduleTuTtc>(entity =>
        {
            entity.HasKey(e => e.AppointmentScheduleTuTtcid).HasName("PK__Appointm__2E0A6016FC66BB9F");
            ...
            entity.HasOne(d => d.Booking).WithMany(p => p.AppointmentScheduleTuTtcs)
                ...
                .HasConstraintName("FK__Appointme__Booki__5165187F");

            entity.HasOne(d => d.UserAccount).WithMany(p => p.AppointmentScheduleTuTtcs)
                .HasForeignKey(d => d.UserAccountId)
                .HasConstraintName("FK__Appointme__UserA__52593CB8");
        });

        modelBuilder.Entity<BookingMinhNDA>(entity =>
        {
            entity.HasKey(e => e.BookingMinhNdaid).HasName("PK__BookingM__D75104A8C4EE1A14");
            ...
            entity.HasOne(d => d.ServiceAnhThq).WithMany(p => p.BookingMinhNda)
                ...
                .HasConstraintName("FK__BookingMi__Servi__3F466844");

            entity.HasOne(d => d.UserAccount).WithMany(p => p.BookingMinhNda)
                .HasForeignKey(d => d.UserAccountId)
                .HasConstraintName("FK__BookingMi__UserA__3E52440B");
        });

        modelBuilder.Entity<FeedbackNguyenTq>(entity =>
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDF622643DA8");
            ...
            entity.HasOne(d => d.KitDeliveryNguyenTq).WithMany(p => p.FeedbackNguyenTqs)
                ...
                .HasConstraintName("FK__FeedbackN__KitDe__5DCAEF64");

            entity.HasOne(d => d.UserAccount).WithMany(p => p.FeedbackNguyenTqs)
                .HasForeignKey(d => d.UserAccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__FeedbackN__UserA__5EBF139D");
        });

        modelBuilder.Entity<InvoiceMinhNDA>(entity =>
        {
            entity.HasKey(e => e.InvoiceMinhNdaid).HasName("PK__InvoiceM__46006282209AD070");
            ...
            entity.HasOne(d => d.BookingMinhNda).WithMany(p => p.InvoiceMinhNda)
                ...
                .HasConstraintName("FK__InvoiceMi__Booki__4222D4EF");
        });

        modelBuilder.Entity<KitDeliveryNguyenTq>(entity =>
        {
            entity.HasKey(e => e.KitDeliveryNguyenTqid).HasName("PK__KitDeliv__F2900504EE77430E");
            ...
            entity.HasOne(d => d.BookingMinhNda).WithMany(p => p.KitDeliveryNguyenTqs)
                .HasForeignKey(d => d.BookingMinhNdaid)
                .HasConstraintName("FK__KitDelive__Booki__59063A47");
        });

        modelBuilder.Entity<RelationshipTestThanhDc>(entity =>
        {
            entity.HasKey(e => e.RelationshipTestThanhDcid).HasName("PK__Relation__C37139696ABACE44");
            ...
            entity.HasOne(d => d.TestResultThanhDc).WithMany(p => p.RelationshipTestThanhDcs)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Relations__TestR__4E88ABD4");
        });

        modelBuilder.Entity<SampleNhanTtt>(entity =>
        {
            entity.HasKey(e => e.SampleNhanTttid).HasName("PK__SampleNh__CD302BF47740196F");
            ...
            entity.HasOne(d => d.BookingMinhNda).WithMany(p => p.SampleNhanTtts)
                .HasForeignKey(d => d.BookingMinhNdaid)
                .HasConstraintName("FK__SampleNha__Booki__44FF419A");
        });

        modelBuilder.Entity<SampleTestResultNhanTtt>(entity =>
        {
            entity.HasKey(e => e.SampleTestResultNhanTttid).HasName("PK__SampleTe__3570092459B0B69E");
            ...
            entity.HasOne(d => d.SampleNhanTtt).WithMany(p => p.SampleTestResultNhanTtts)
                ...
                .HasConstraintName("FK__SampleTes__Sampl__47DBAE45");
        });

        modelBuilder.Entity<ServicePriceListAnhThq>(entity =>
        {
            entity.HasKey(e => e.ServicePriceListAnhThqid).HasName("PK__ServiceP__626BFA4362DCF4A9");
            ...
            entity.HasOne(d => d.ServiceAnhThq).WithMany(p => p.ServicePriceListAnhThqs)
                .HasForeignKey(d => d.ServiceAnhThqid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ServicePr__Servi__3B75D760");
        });

        modelBuilder.Entity<ServiceAnhThq>(entity =>
        {
            entity.HasKey(e => e.ServiceAnhThqid).HasName("PK__Services__D07B05F47F3E5CB8");
        ...
        {
            entity.HasKey(e => e.TestResultThanhDcid).HasName("PK__TestResu__D113AF64E084A44A");
            ...
            entity.HasOne(d => d.BookingMinhNda).WithMany(p => p.TestResultThanhDcs)
                .HasForeignKey(d => d.BookingMinhNdaid)
                .HasConstraintName("FK__TestResul__Booki__4AB81AF0");
        });

        modelBuilder.Entity<UserAccount>(entity =>
        {
            entity.HasKey(e => e.UserAccountId).HasName("PK__UserAcco__DA6C70BAC66ADEA7");
